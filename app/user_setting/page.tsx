      ...
      <div className="max-w-[1500px] mx-auto h-[800px]">
        <div className="bg-white rounded-3xl shadow-lg p-8 relative w-full h-full">
          ...
          <div className="flex justify-center items-center mb-4">
            {userPhoto ? (
              <Image
                ...
                width={160} // Set the width (40 * 4 = 160px for consistency with your design)
                height={160} // Set the height (40 * 4 = 160px for consistency with your design)
              ...
              <div className="bg-blue-500 rounded-full w-40 h-40 flex items-center justify-center text-white text-5xl">
                ...
                {/* Tampilkan huruf depan dari nama */}
              </div>
            )}
          </div>
          ...
          <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 mb-4">
            <h2 className="text-center text-gray-500">si-itikpolije2024.com</h2>
          </div>
